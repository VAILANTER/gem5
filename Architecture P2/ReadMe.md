...
Έχοντας το κόστος για κάθε υλοποίηση της cache μέσω της παραπάνω συνάρτησης αλλά και το τελικό CPI από την εκτέλεση των benchmark μπορούμε να βρούμε τις παραμέτρους της cache που βελτιστοποιούν την απόδοση του συστήματος σε σχέση με το κόστος. Χρησιμοποιώντας ως συνάρτηση αξιολόγησης την Points = 10^6 / (CPI * Cost), όπου αυξάνεται όσο το κόστος και το CPI μειώνονται, μπορούμε να βρούμε την βέλτιστη αρχιτεκτονική.  
Παρακάτω δίνονται οι βέλτιστες αρχιτεκτονικές για κάθε benchmark: 

**bzip2**: --l1d_size=64kB --l1i_size=64kB --l2_size=512kB --l1i_assoc=4 --l1d_assoc=4 --l2_assoc=8 --cacheline_size=64 με 16,184 πόντους βαθμολογίας  
**mcf**: --l1d_size=64kB --l1i_size=64kB --l2_size=512kB --l1i_assoc=4 --l1d_assoc=4 --l2_assoc=8 --cacheline_size=64 με 24,747 πόντους βαθμολογίας  
**hmmer**: --l1d_size=64kB --l1i_size=64kB --l2_size=512kB --l1i_assoc=4 --l1d_assoc=4 --l2_assoc=8 --cacheline_size=64 με 23,783 πόντους βαθμολογίας  
**sjeng**: --l1d_size=64kB --l1i_size=64kB --l2_size=1024kB --l1i_assoc=2 --l1d_assoc=2 --l2_assoc=8 --cacheline_size=256 με 8,725 πόντους βαθμολογίας  
**lbm**: --l1d_size=64kB --l1i_size=32kB --l2_size=256kB --l1i_assoc=2 --l1d_assoc=2 --l2_assoc=8 --cacheline_size=128 με 21,096 πόντους βαθμολογίας  
